...
pub fn get_configuration() -> Result<Settings, config::ConfigError> {
    ...
    let settings = config::Config::builder()
        ...
        .add_source(config::File::from(configuration_directory.join(format!("{}.yaml", environment.as_str()))))
        // allows for environment variables to override configuration files (e.g. APP_APPLICATION__PORT=5001)
